...
import MajorCardCompany from "./pages/search/MajorCardCompany";
  ...
  return (
    <div>
      <Routes>
        ...
        {/* 주요 카드사 선택 페이지 */}
        <Route path="/search-card-company" element={<MajorCardCompany />} />
        {/* 기타 카드사 선택 페이지 */}
        <Route
          path="/search-extra-card-company"
          element={<ExtraCardCompany />}
        />
        {/* 카드 순위 페이지 */}
